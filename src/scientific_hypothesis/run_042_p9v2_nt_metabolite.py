...
Pre-registration: runs/run_042_p9v2_nt_metabolite/preregistration.md

Usage:
    python -m src.scientific_hypothesis.run_042_p9v2_nt_metabolite
"""
...
from src.scientific_hypothesis.build_p9v2_kg import (
    build_p9_from_base,
    P9_ENTITY_TERMS,
    P9_NT_IDS,
    ALL_BRIDGE_IDS_P9,
...
RUN_DIR = os.path.join(BASE_DIR, "runs", "run_042_p9v2_nt_metabolite")
...
def _save_run_config(ts: str, ta: dict, results: dict) -> None:
    ...
    cfg = {
        "run_id": "run_042_p9v2_nt_metabolite",
        "timestamp": ts,
        "phase": "P9",
        "seed": SEED,
        "top_k": TOP_K,
