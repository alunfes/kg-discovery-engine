# Review Memo — sprint_t_fusion_decay_batch
...
- **positioning_unwind**: count=10, mean=0.7345, median=0.7055, p90=0.8099, count_norm_top_k=1.0, ev_slope=-0.0148, arch_advantage=False
...
- **alt_led**: n=6, dominant=positioning_unwind, mean_score=0.7154, top_k_share=1.0
...
- **funding_shifted**: n=10, dominant=positioning_unwind, mean_score=0.7345, top_k_share=1.0
- **high_coverage**: n=10, dominant=positioning_unwind, mean_score=0.7345, top_k_share=1.0
- **high_oi_growth**: n=6, dominant=positioning_unwind, mean_score=0.7404, top_k_share=1.0
...
- mean_uplift_by_branch: {'positioning_unwind': 0.2065}
- top_uplift (complexity-adjusted):
  ...
  - [positioning_unwind] E2 positioning unwind: (HYPE,ETH) — one-sided OI b uplift=0.2250 conf=low
  - [positioning_unwind] E2 positioning unwind: (HYPE,SOL) — one-sided OI b uplift=0.2250 conf=low
...
- n_top_k_changed: 0
- mean_uplift_aware_score: 0.2928
- Top-5 uplift-aware cards:
  ...
  3. [positioning_unwind] E2 positioning unwind: (HYPE,ETH) — one-sided OI b ua=0.3669 raw=0.745 rank_Δ=+0
  4. [positioning_unwind] E2 positioning unwind: (HYPE,SOL) — one-sided OI b ua=0.3669 raw=0.745 rank_Δ=+0
  5. [positioning_unwind] E2 positioning unwind: (HYPE,ETH) — funding pressu ua=0.1658 raw=0.706 rank_Δ=+0
...
- Tier counts:
  - research_priority: 6 (60.0%)
  - actionable_watch: 4 (40.0%)
- actionable_watch top cards:
  ...
  - [positioning_unwind] E2 positioning unwind: (HYPE,ETH) — one-sided OI build + cro score=0.745
  - [positioning_unwind] E2 positioning unwind: (HYPE,SOL) — one-sided OI build + cro score=0.745
...
- High-urgency (actionable_watch) cards:
  ...
  - [positioning_unwind] E2 positioning unwind: (HYPE,SOL) — one-sided OI build  label=positioning_unwind_watch
...
> Correlation break (HYPE,BTC) rho=-0.043. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,BTC) rho=-0.043, break_score=0.176. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
...
> Correlation break (HYPE,ETH) rho=0.024. OneSidedOIBuildNode (score=1.000, duration=29) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,SOL) rho=-0.052. OneSidedOIBuildNode (score=1.000, duration=27) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,ETH) rho=0.024, break_score=0.273. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
