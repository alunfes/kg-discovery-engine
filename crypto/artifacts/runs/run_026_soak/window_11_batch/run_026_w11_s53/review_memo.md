...
> Correlation break (HYPE,BTC) rho=0.150. OneSidedOIBuildNode (score=1.000, duration=31) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,BTC) rho=0.150, break_score=0.339. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
...
> Correlation break (HYPE,SOL) rho=-0.059. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,ETH) rho=-0.109, break_score=0.269. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
