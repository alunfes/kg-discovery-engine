...
- **positioning_unwind**: count=10, mean=0.7322, median=0.7055, p90=0.8099, count_norm_top_k=1.0, ev_slope=-0.011, arch_advantage=False
...
- **alt_led**: n=6, dominant=positioning_unwind, mean_score=0.7116, top_k_share=1.0
...
- **funding_shifted**: n=10, dominant=positioning_unwind, mean_score=0.7322, top_k_share=1.0
- **high_coverage**: n=10, dominant=positioning_unwind, mean_score=0.7322, top_k_share=1.0
- **high_oi_growth**: n=6, dominant=positioning_unwind, mean_score=0.7366, top_k_share=1.0
...
- mean_uplift_by_branch: {'positioning_unwind': 0.2042}
...
- n_top_k_changed: 0
- mean_uplift_aware_score: 0.2832
- Top-5 uplift-aware cards:
  ...
  3. [positioning_unwind] E2 positioning unwind: (HYPE,SOL) — one-sided OI b ua=0.3830 raw=0.745 rank_Δ=+0
  4. [positioning_unwind] E2 positioning unwind: (HYPE,ETH) — one-sided OI b ua=0.2553 raw=0.722 rank_Δ=+0
...
> Correlation break (HYPE,BTC) rho=-0.084. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,BTC) rho=-0.084, break_score=0.586. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
...
### 3. E2 positioning unwind: (HYPE,SOL) — one-sided OI build + crowding
**Composite:** 0.745 | **Secrecy:** internal_watchlist | **Status:** weakly_supported

> Correlation break (HYPE,SOL) rho=-0.050. OneSidedOIBuildNode (score=1.000, duration=29) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,ETH) rho=0.109. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,ETH) rho=0.109, break_score=0.353. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
