...
> Correlation break (HYPE,BTC) rho=-0.022. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,BTC) rho=-0.022, break_score=0.389. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
...
> Correlation break (HYPE,ETH) rho=0.222. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,SOL) rho=-0.299. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,ETH) rho=0.222, break_score=0.152. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
