...
- Top-5 uplift-aware cards:
  ...
  3. [positioning_unwind] E2 positioning unwind: (HYPE,ETH) — one-sided OI b ua=0.3830 raw=0.745 rank_Δ=+0
  4. [positioning_unwind] E2 positioning unwind: (HYPE,SOL) — one-sided OI b ua=0.2553 raw=0.722 rank_Δ=+0
...
> Correlation break (HYPE,BTC) rho=-0.087. OneSidedOIBuildNode (score=1.000, duration=29) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,BTC) rho=-0.087, break_score=0.478. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
...
> Correlation break (HYPE,ETH) rho=0.065. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,SOL) rho=-0.128. OneSidedOIBuildNode (score=1.000, duration=24) → PositionCrowdingStateNode. Crowd unwind expected.
...
> Correlation break (HYPE,ETH) rho=0.065, break_score=0.431. FundingPressureRegimeNode (score=1.000) → FragilePremiumStateNode → UnwindTriggerNode (type=funding_extreme). Positioning unwind expected within 1-2 epochs.
